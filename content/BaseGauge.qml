...
Item {
    ...
    width: Constants.gaugeSize;
    height: Constants.gaugeSize;

    property int transformOriginX: isLeft ? 60 : 280
    ...
    Image {
        ...
        transform: [
            Rotation {
                ...
                angle: minAngle/0.0174532925 + 180 + animatedValue * (isLeft ? 1 : -1) * (maxAngle - minAngle) / maxValue
            },
            Scale {
